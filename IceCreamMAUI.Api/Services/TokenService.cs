...
namespace IceCreamMAUI.Api.Services
{
    public class TokenService(IConfiguration configuration)
    {
        ...
        {
            var secretKey = configuration["Jwt:SecretKey"];// the configuration is defined under appsettings.Development.json
            var securityKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(secretKey!));//converting the secretKey to byte array
